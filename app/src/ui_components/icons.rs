...
pub fn render_speaker_icon(painter: &Painter, rect: Rect, color: Color32) {
    ...
    let dim_stroke = Stroke::new(1.1, Color32::from_rgba_unmultiplied(color.r(), color.g(), color.b(), 160));
...
pub fn render_mute_icon(painter: &Painter, rect: Rect, color: Color32) {
    ...
    painter.line_segment(
        ...
        Stroke::new(1.6, Color32::from_rgb(255, 95, 87)),
    );
}
...
pub fn render_search_icon(painter: &Painter, rect: Rect, color: Color32) {
    ...
    // Glass circle
    painter.circle_stroke(lens_c, r, Stroke::new(1.4, color));
    ...
    painter.line_segment([h_start, h_end], Stroke::new(1.9, color));
}
...
pub fn render_document_icon(painter: &Painter, rect: Rect, color: Color32) {
    ...
    painter.line_segment([pos2(min_x + w * 0.22, c.y + h * 0.05), pos2(max_x - w * 0.22, c.y + h * 0.05)], Stroke::new(1.0, line_col));
    painter.line_segment([pos2(min_x + w * 0.22, c.y + h * 0.24), pos2(max_x - w * 0.35, c.y + h * 0.24)], Stroke::new(1.0, line_col));
}
...
pub fn render_pen_icon(painter: &Painter, rect: Rect, color: Color32) {
    ...
    painter.line_segment([p_tip, p_top], Stroke::new(2.2, color));
